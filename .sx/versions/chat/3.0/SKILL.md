...
5. **Event naming** - Use camelCase for all Vue event names (e.g., `sessionUpdated`, not `session-updated`)
...
5. Iterate based on behavior and user feedback and new changes
