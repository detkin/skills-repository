...
emit('sessionUpdated', sessionId) // Session data changed, trigger refresh
emit('specUpdated', specHash)    // Spec data changed, trigger refresh
emit('evaluationComplete')       // Evaluation completed, trigger refresh
```
...
<template>
  <div class="right-pane">
    <IssuesChatInterface
      ...
      @stop="stopLLM"
      @sessionUpdated="handleDomainUpdated"
    />
  </div>
</template>
```
